...
<div class="container">
    ...
    <div class="row text-white">
        <div class="col-md-6 ">
            <img src="admin/<?php echo $thumb ?>" alt="" class='img-fluid' style='height:500px;width:700px; object-fit: contain;'>
        </div>
        <div class="col-md-6 pt-5">
        <h3><b><?php echo $product_name ?></b></h3>
        <h2><b>&dollar; <?php echo  $price ?>.00 </b></h2>
...
//  }
 ...
 ?>
                ...
                <li>
                    ...
                    <div class="price"> &dollar;<b><?php echo $row_related['price']; ?> </b></div>
